...
For contributors: Ideas and suggestions for GTE-related projects
================================================================

There are a number of opportunities for programmers of all
skill levels and backgrounds to contribute to improving and extending
GTE.

Web interface / GUI improvements
--------------------------------
